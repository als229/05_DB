...
--  - 테이블에 값을 삽입, 수정, 삭제 하는 구문

-- 1. INSERT(삽입하다)

-- 1) INSERT INTO 테이블명 VALUES(...);
-- 2) INSERT INTO 테이벌명(컬럼명...) VALUES(...);
...
-- 수정 확인 후 ROLLBACK;
SELECT * FROM EMPLOYEE2 WHERE EMP_NAME IN ('노옹철' ,'전형돈' ,'정중하', '하동운');
SELECT * FROM EMPLOYEE2 WHERE SALARY = 4400000;
...
SELECT E.EMP_ID, E.BONUS , L.LOCAL_NAME 
FROM EMPLOYEE2 E
